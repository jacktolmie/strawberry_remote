...
QString toString(Arguments value) {
    switch (value) {
        ...
        case Arguments::DESCRIPTION:        return u"description"_s;
        case Arguments::DONATE:             return u"donate"_s;
        ...
        case Arguments::QUALITY:            return u"quality"_s;
        ...
        case Arguments::STREAM_URL:         return u"stream_url"_s;
        case Arguments::TAGS:               return u"tags"_s;
