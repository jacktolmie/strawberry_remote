...
void RemoteRadio::radioBrowserParse(const QJsonObject& data, const QString radioStation){
...
void RemoteRadio::radioParadiseParse(const QJsonObject& data, const QString radioStation){
    ...
    for (auto chan : channels){
        ...
        station[toString(Arguments::ID)] = QString::number(chan_obj[u"chan_id"_s].toInt());
        station[toString(Arguments::NAME)] = chan_obj[u"chan_name"_s].toString();
        station[toString(Arguments::IMAGE)] = chan_obj[u"image"_s].toString();
        station[toString(Arguments::GENRE)] = QString();
        station[toString(Arguments::COUNTRY)] = QString();
        station[toString(Arguments::DESCRIPTION)] = chan_obj[u"chan_name"_s].toString();
        ...
        for (auto playlist : playlists){
            ...
            playlist_data[toString(Arguments::STREAM_URL)] = playlist_obj[u"url"_s].toString();
            playlist_data[toString(Arguments::FORMAT)] = playlist_obj[u"label"_s].toString();
            playlist_data[toString(Arguments::QUALITY)] = playlist_obj[u"stream_id"_s].toString();
...
void RemoteRadio::somaFmParse(const QJsonObject& data, const QString radioStation){
    ...
    for (auto chan : channels){
        ...
        station[toString(Arguments::ID)] = QString::number(chan_obj[u"id"_s].toInt());
        station[toString(Arguments::NAME)] = chan_obj[u"title"_s].toString();
        station[toString(Arguments::IMAGE)] = chan_obj[u"image"_s].toString();
        station[toString(Arguments::GENRE)] = chan_obj[u"genre"_s].toString();
        station[toString(Arguments::COUNTRY)] = QString();
        station[toString(Arguments::DESCRIPTION)] = chan_obj[u"description"_s].toString();
        station[toString(Arguments::STATION_URL)] = QString();
        station[toString(Arguments::DONATE)] = QString();
        ...
        for (auto playlist : playlists){
            ...
            playlist_data[toString(Arguments::STREAM_URL)] = playlist_obj[u"url"_s].toString();
            playlist_data[toString(Arguments::FORMAT)] = playlist_obj[u"format"_s].toString();
            playlist_data[toString(Arguments::QUALITY)] = playlist_obj[u"quality"_s].toString();
            playlist_array.append(playlist_data);
        }
        station[u"playlists"_s] = playlist_array;
        station_array.append(station);
